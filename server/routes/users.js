 ...
 *     tags: [Users]
 *     description: Populate the database with dummy user data (Admin only)
 *     security:
 *       - bearerAuth: []
 *     responses:
 *       200:
 ...
 *                 message:
 *                   type: string
 *                   example: Dummy users seeded successfully
 *                 count:
 *                   type: number
 *                   example: 10
 *       401:
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post('/seed', protect, authorize('admin'), seedUsers);
